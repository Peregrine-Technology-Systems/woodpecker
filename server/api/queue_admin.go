...
// Queue admin handlers extracted from hook.go (#191) — webhook handling and
// queue admin are unrelated concerns. Splitting them lets the file-scoped
// coverage gate apply per-domain. No behavior change.
